...
public class Transaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnTmbh, new org.netbeans.lib.awtextra.AbsoluteConstraints(108, 472, -1, -1));
    ...
    private void btnTmbhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTmbhActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) table.getModel();//untuk membuat model pad table 
        ...
        //memasukkan variable pada model
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            //memasukkakn data pada database tb_penjualan
    ...
    private void jBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBarangMouseClicked
        // mengambil isi dari jbarang
        String kode = (String) jBarang.getSelectedItem();
        String sql = "select * from tb_menu where id_menu='" + kode + "'";//mengambil data dari databse dgn kondisi idmenu harus sama dengan kode
        try {
            rs = stat.executeQuery(sql);
            while (rs.next()) {
                String nama = rs.getString("menu");//mengambil isi dari tabel brg dengn field menu
                txtNamaBarang.setText(nama);
                txtHarga.setText(rs.getString("harga"));//mengambil isi dari tabel brg dengn field harga
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
    ...
    private void generateID() {
        try {
            ...
            i++;
            int no = i;
            //mengubah int ke string dari variable no
            String Id = Integer.toString(no);
            String tambahan = "000";
            // menghitung pnjng karkter    
            int length = tambahan.length() - Id.length();
            String SubString = tambahan.substring(0, length);// mengambil beberapa karakter dari variable tambahan
            txtIdTransaksi.setText("TR" + SubString + Id);// menambahkan TR pada txtidtrnsksi
        } catch (Exception e) {
    ...
    private void setTotal() {
        int total = 0;
        for (int i = 0; i < table.getRowCount(); i++) { // mengitung baris dari tabel
